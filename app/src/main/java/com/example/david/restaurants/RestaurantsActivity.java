...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    private String[] cuisines = new String[] {"Vegan Food", "Breakfast", "Fish Dishes", "Scandinavian", "Coffee", "English Food", "Burgers", "Fast Food", "Noodle Soups", "Mexican", "BBQ", "Cuban", "Bar Food", "Sports Bar", "Breakfast", "Mexican" };
    @Override
